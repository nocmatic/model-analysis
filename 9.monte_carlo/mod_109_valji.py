...
ro_rV4 = volumen_valji3(1000000,1,10)[0]
ro_rM4  = volumen_valji3(1000000,1,10)[1]
ro_rJ4 = volumen_valji3(1000000,1,10)[2]
print (ro_rV4,ro_rM4,ro_rJ4)
print(r'napake: %.5f, %.5f, %.6f'%(volumen_valji3(1000000,1,10)[3],volumen_valji3(1000000,1,10)[4],volumen_valji3(1000000,1,10)[5]))
